...
export default function SimulationLoadingCard({ optimizationStatus, optimizedPoints, onComplete, simulationType }) {
    ...
    useEffect(() => {
        console.log(`Phase: ${phase}, SimulationType: ${simulationType}`); // Debug log
        if (phase === 1) {
            let index = 0;
    ...
    }, [phase, simulationType]);

    useEffect(() => {
        if (phase === 2) {
            console.log(`Rendering animation for: ${simulationType}`);
            ...
            <div className="ap-simulation-center">
                ...
                {phase === 2 && (
                    <div className="ap-loading-center">
                        {simulationType === "Atık Yönetimi" ? (
                            <div className="loader truck-loader" role="status" aria-label="Yükleniyor">
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z"
                            ...
                            <div className="loader rain-loader" role="status" aria-label="Yükleniyor">
                                <div className="snow">
                                    {[...Array(22)].map((_, i) => (
                                        <span
                                            key={i}
